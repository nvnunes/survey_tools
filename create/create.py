...
def load_3DHST(field):
    ...
    catalog_3DHST = catalog.CatalogData(catalog_params_3DHST, force_tables=True)
...
def load_UVISTA():
    ...
    catalog_UVISTA = catalog.CatalogData(catalog_params_UVISTA)
...
def cross_match_3DHST(catalog_master, field):
    catalog_params_3DHST = catalog.get_params('3D-HST', field, 'F160W')
    catalog_3DHST = catalog.CatalogData(catalog_params_3DHST)
...
def cross_match_ZCB(catalog_master):
    ...
    catalog_ZCB = catalog.CatalogData(catalog_params_ZCB)
...
def cross_match_ZCD(catalog_master):
    ...
    catalog_ZCD = catalog.CatalogData(catalog_params_ZCD)
...
def cross_match_VUDS(catalog_master, field):
    ...
    catalog_VUDS = catalog.CatalogData(catalog_params_VUDS)
...
def cross_match_Casey(catalog_master, field):
    ...
    catalog_Casey = catalog.CatalogData(catalog_params_Casey)
...
def cross_match_DEMOS(catalog_master):
    ...
    catalog_DEIMOS = catalog.CatalogData(catalog_params_DEIMOS)
...
def cross_match_MOSDEF(catalog_master, field):
    ...
    catalog_MOSDEF = catalog.CatalogData(catalog_params_MOSDEF)
...
def cross_match_FMOS(catalog_master):
    ...
    catalog_FMOS = catalog.CatalogData(catalog_params_FMOS)
...
def cross_match_KMOS3D(catalog_master, field):
    ...
    catalog_KMOS3D = catalog.CatalogData(catalog_params_KMOS3D)
    if catalog_master.catalog == '3DHST':
...
def cross_match_C3R2(catalog_master, field):
    ...
    catalog_C3R2 = catalog.CatalogData(catalog_params_C3R2)
...
def cross_match_LEGAC(catalog_master):
    ...
    catalog_LEGAC = catalog.CatalogData(catalog_params_LEGAC)
    if catalog_master.catalog == 'UVISTA':
...
def cross_match_HSCSSP(catalog_master, field):
    ...
    catalog_HSCSSP = catalog.CatalogData(catalog_params_HSCSSP)
...
def cross_match_DESI(catalog_master, field, region, region_wcs):
    ...
    catalog_DESI = catalog.CatalogData(catalog_params_DESI, region=region, region_wcs=region_wcs)
